...
export default function PomodoroTimer({ onComplete, coins }: PomodoroTimerProps) {
  ...
  const [selectedBackground, setSelectedBackground] = useState('/placeholder.svg?height=1080&width=1920')
  const [showBackgroundModal, setShowBackgroundModal] = useState(false)

  const backgrounds = [
    { id: 1, url: '/placeholder.svg?height=1080&width=1920', price: 50 },
    { id: 2, url: '/placeholder.svg?height=1080&width=1920', price: 100 },
    { id: 3, url: '/placeholder.svg?height=1080&width=1920', price: 150 },
  ]
